      ...
      <div className="container py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-3 md:col-start-7">
            <h4 className="text-sm font-semibold uppercase tracking-[0.2em] mb-6">Navigation</h4>
            <nav className="flex flex-col space-y-4">
              {[
                ...
                <Link key={link.to} to={link.to} className="text-muted-foreground hover:text-foreground transition-colors group flex items-center">
                  {link.label}
          ...
          <div className="md:col-span-3">
            <h4 className="text-sm font-semibold uppercase tracking-[0.2em] mb-6">Get in Touch</h4>
            <div className="space-y-4">
              {profile.email && (
                <a href={`mailto:${profile.email}`} className="block text-muted-foreground hover:text-foreground transition-colors">
                  {profile.email}
                </a>
              )}
              <Link to="/contact" className="inline-flex items-center text-foreground font-medium group">
                Send a Message
